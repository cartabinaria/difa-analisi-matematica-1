...
\usepackage[a4paper,top=4cm,bottom=4cm,left=2.5cm,right=2.5cm,margin=1in]{geometry}
...
Allora si ha che
\begin{equation}
    \forall \,\,\, M>0 \,\,\, \exists \,\,\, N>0 \,\,\, \mbox{tale che, se}\,\,\, x  \lessgtr \pm N, \,\,\, \mbox{allora} f(x)> \lessgtr \pm M
\end{equation}
...
\end{center}
    ...
    Suppongo sia finito il $\lim_{y \to y_0}f(y)=l$.
    \\
    Fisso$\varepsilon>0$ e CERCO se $\exists \,\,\, \overline{\delta} >0$ tale che, se $|x-x_0|<\overline{\delta}$
    \begin{equation}
        |f(g(x))-l|<\varepsilon
    \end{equation}
 \begin{enumerate}
...
\begin{enumerate}
    ...
    \item $a_n \sim b_n$, $\sum a_n < +\infty \Longleftrightarrow \sum b_n < +\infty$
    \end{enumerate}
    \begin{center}
        \textbf{\textit{Dimostrazione}}
    \end{center}
...
\end{center}
$a_n \sim b_n \,\, \Longrightarrow \,\, a_n=O(b_n)$ e che $b_n=O(a_n)$.
\\
...
\end{center}
$\sum \frac{1}{n^p}$ converge, ossia $\sum \frac{1}{n^p} < +\infty \,\, \Longleftrightarrow \,\,  \sum \frac{2^n}{(2^n)^p} < +\infty$ (Infatti se $p >0$, se $p \leqslant 0$, $a_n \nrightarrow 0$).
\\
...
\begin{itemize}
    ...
    \\
    In pratica $b_n$ è asintotica a una cosa che converge ma lei non converge. Infatti è possibile sviluppare con Taylor la successione $ln(1+ \frac{(-1)^n}{\sqrt{n}})$ chiamando $x=\frac{(-1)^n}{\sqrt{n}} \to 0$, in quanto infinitesima per limitata. Lo sviluppo a secondo orine sarà allora: $ln(1+ \frac{(-1)^n}{\sqrt{n}})=\frac{(-1)^n}{\sqrt{n}}-\frac{(-1)^{2n}}{2n}+o(\frac{1}{n}) \sim \frac{(-1)^n}{\sqrt{n}}-\frac{1}{2n}$, che non può convergere perchè $\sum\frac{1}{2n}$ diverge, come dimostrato all'inizio. Dunque osserviamo che, se usiamo il criterio del confronto asintotico partendo da una serie a segno costante per arrivare a una serie a segno non costante (in questo caso $\frac{(-1)^n}{\sqrt{n}}-\frac{1}{2n}$), il criterio del confronto asintotico non vale, come del resto si può osservare dalle ipotesi del criterio stesso.
\end{itemize}
...
\begin{equation*}
    inf (f) (U) \leqslant sup(f)(U) \,\, \Longrightarrow \,\, S(f,P) \geqslant s(f,P)
\end{equation*}
...
\\
Infine sono una \textbf{\textit{coppia di Dedekind}}, dunque, essendo $ \in \R$, $\exists$ un elemento $\gamma$ chiamato \textit{separatore}.
\begin{center}
    \textbf{\textit{Definizione}}
\end{center}
...
Siano $f$ continua e $\varphi$ derivabile con derivata continua.
\\
...
Se $R=+\infty$, allora $\forall r \in \R$, con $r > 0$, $\sum a_nr^n \,\,\,\, \in \R$, ma allora, fissato $M>0$, considero $r=M+1$ e ho che $\sum a_nr^n \,\,\, \in \R$, e dunque $\sum a_nx^n$ \textbf{converge totalmente} sull'intervallo $[-M,M]$
\end{itemize}
\begin{center}
...
\\
Ora, se $L=0$, ho che $\sqrt[n]{|a_nx^n|} \to 0 \,\,\, \forall \,\,\, x \in \R$.
\begin{itemize}
